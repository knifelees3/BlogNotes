...
以前不理解Python虚拟环境，听名字觉得不明所以，查看[文档](https://docs.python.org/zh-cn/3/tutorial/venv.html)后觉得非常简单。下面做一个记录
...
pip 有更多选择。有关 pip 的完整文档，请参阅 安装 [Python 模块 指南](https://docs.python.org/zh-cn/3/installing/index.html#installing-index)。当您编写一个包并希望在 Python 包索引中使它可用时，请参考 [分发 Python 模块](https://docs.python.org/zh-cn/3/distributing/index.html#distributing-index) 指南。
